...
- **Unemployment rate level and direction.** The BoC has moved away from a single point NAIRU estimate. SAN 2025-17 ([Benchmarks for Assessing Labour Market Health, June 2025](https://www.bankofcanada.ca/2025/06/staff-analytical-note-2025-17/)) uses a multi-indicator benchmark approach (unemployment, employment rate, vacancies, involuntary part-time, average hours) rather than a fixed threshold; the Bank explicitly states accelerationist Phillips curves are no longer in its main models and that the NAIRU concept "is not applicable to a wider set of labour market measures." The most recent cited "natural rate" range was 5.5–6.5% in a 2019 speech, but the Bank's current characterization uses qualitative language ("modest excess supply," "tight") rather than a number. Direction matters as much as level — rising = slack opening; falling = tightening. The pace of change is itself a signal.
...
**Thresholds (verified May 2026):**
- **No fixed NAIRU.** BoC uses a multi-indicator benchmark approach (SAN 2025-17). Characterize unemployment relative to recent history and BoC's qualitative read ("modest excess supply" vs. "tight") rather than against a number.
