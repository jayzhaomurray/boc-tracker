...
| `core_band_width` | max(core) − min(core) across 5 measures in pp, monthly, since 2000, N=315 | wide / narrow | none | typical ≤0.70pp; uncommon to 1.00pp; pronounced to 1.40pp; rare to 1.90pp; extreme >1.90pp | 2026-05-09 | `analyses/inflation_distribution.py` |
...
| `usdcad_level` | `\|USDCAD − long-run median 1.3072\|` in CAD, monthly month-last, since 1990, N=437 | high (weak CAD) / low (strong CAD) | none | typical ≤0.0958; uncommon to 0.2343; pronounced to 0.3068; rare to 0.3374; extreme >0.3374 | 2026-05-09 | `analyses/financial_distribution.py` |
